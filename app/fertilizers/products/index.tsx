/**
 * @module app/fertilizers/products/index
 * 定番肥料ガイド一覧画面。
 * useFertilizerColumnsQuery に category: 'product_guide' を渡した絞り込み一覧。
...
// category は固定値
const PRODUCT_GUIDE_CATEGORY = 'product_guide' as const;
const CATEGORY_LABEL = '定番肥料ガイド';
...
export default function FertilizerProductsScreen() {
  ...
  const {
    ...
    isFetchingNextPage,
    refetch,
  } = useFertilizerColumnsQuery(PRODUCT_GUIDE_CATEGORY);
  ...
  if (isLoading) {
    return (
      <View style={styles.container}>
        <Stack.Screen options={{ title: '定番肥料ガイド', headerShown: true }} />
